...
let lastMoveTime = 0; // 用于控制蛇的移动速度
const moveInterval = 300; // 降低蛇的移动速度，将时间间隔从 200ms 增加到 300ms
...
setInterval(moveSnake, moveInterval); // 控制蛇的移动速度
requestAnimationFrame(renderGame); // 以高帧率渲染游戏
